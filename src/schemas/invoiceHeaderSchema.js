...
const invoiceHeaderSchema = Joi.object().keys({
    ...
    shipping_name: Joi.string().max(50).default(Joi.ref('fiscal_name')),
    shipping_address: Joi.string().max(100).default(Joi.ref('address')),
    shipping_postal_code: Joi.string().max(5).default(Joi.ref('postal_code')),
    shipping_city: Joi.string().max(50).default(Joi.ref('city')),
    shipping_country: Joi.string().max(50).default(Joi.ref('country')),
    shipping_phone: telJoi.string().phoneNumber().default(Joi.ref('phone')),
